...
function getSafeWithCustomScriptDisabledProperty(manifest) {
    var safeWithCustomScriptDisabled = !!manifest.safeWithCustomScriptDisabled;
    delete manifest.safeWithCustomScriptDisabled;
    return safeWithCustomScriptDisabled;
}
function createExtensionComponent(manifest) {
    var safeWithCustomScriptDisabled = getSafeWithCustomScriptDisabledProperty(manifest);
    return {
        name: manifest.alias,
        ...
        safeWithCustomScriptDisabled: safeWithCustomScriptDisabled,
        componentDefinition: {}
    };
}
